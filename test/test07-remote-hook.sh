...
sleep 1
r1=`ydb -r sub -N --unsubscribe --sync-before-read --read /ge1/enabled`
r2=`ydb -r sub -N --unsubscribe --sync-before-read --read /ge1/enabled`
r3=`ydb -r sub -N --unsubscribe --sync-before-read --read /ge2/enabled`
r4=`ydb -r sub -N --unsubscribe --sync-before-read --read /ge2/enabled`
