...
static struct ymldb_callback *_callback_alloc(ymldb_callback_fn usr_func, void *usr_data, struct ymldb *ydb);
...
static void _callback_run(struct ymldb *ydb, int deleted);
static void _callback_run_pending();
